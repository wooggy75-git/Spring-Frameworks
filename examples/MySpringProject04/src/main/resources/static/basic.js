...
function addProductItem(product) {
    ...
    console.log("[khw] addProductItem")
...
function setMyprice() {
     ...
     */
    console.log("[khw] setMyprice")
    let myprice = $('#myprice').val().trim();
    if (myprice == '') {
        alert("원하시는 최저 가격을 입력해 주세요.");
        $("#myprice").focus();
    }
